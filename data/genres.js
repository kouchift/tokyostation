...
RG.GENRES = [
  ...
  { id: "whs", e: "🌏", label: "世界遺産",         c: "#0B5394", enabled: true,
    desc: "日本の世界遺産 27 件（文化 22・自然 5）。代表の地点に印。押すと «なぜ世界遺産？»・やさしい解説・雑学・クイズ・構成資産の地点" },
  { id: "grave", e: "🪦", label: "偉人の墓",         c: "#5D4037", enabled: true,
    desc: "歴史上の偉人 100 人のお墓（飛鳥〜昭和）。押すと肖像・エピソード・名言・お墓の場所とお参りの案内" },
