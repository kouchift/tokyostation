/* =========================================================================
   ...
   ========================================================================= */
var CACHE = "tsg-v100";
var V = "?v=100";     // index.html の data-build と合わせる
...
var CORE = [
  ...
  "./assets/worker.js", "./manifest.webmanifest", "./assets/icon-192.png", "./assets/fonts/msymbols.woff2?v=100", "./data/lines_meta.js" + V, "./data/genres.js" + V, "./data/score.js" + V, "./data/areas.js" + V, "./data/focus.js" + V
];
