...
var GROUPS = [
  { id: "see",   e: "👀", label: "見る・行く",   c: "#7B3FE4",
    ids: ["near_special", "whs", "grave", "buzz", "yt", "view_jp", "onsen_jp", "mountain", "castle", "shukuba", "river", "zoo", "koshin", "klm", "ichinomiya", "shrine_major", "temple_major", "bunkazai", "history", "worship", "leisure", "museum", "park", "view", "landmark"] },
