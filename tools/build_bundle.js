...
const ORDER = ['app', 'icons', 'score', 'planner', 'plannerui', 'lines_ui', 'basemap', 'three', 'wikicard',
  ...
  'nav', 'traininfo', 'plan', 'logbook', 'geohelp', 'tiles', 'geo', 'zipcode', 'enrich', 'focus', 'buzz', 'qr', 'inro', 'tip', 'shinkansen', 'share', 'nature', 'history', 'places', 'yt', 'air', 'pv', 'card', 'roads', 'quake', 'memo', 'comments_legacy', 'posts', 'obnote', 'sticker', 'alerts', 'weather', 'sns', 'levechi', 'poifilter', 'cvsfilter', 'tokyo', 'favs', 'onsite', 'flow', 'mapfocus', 'stats', 'loader'];
let src = ORDER.map(n => {
