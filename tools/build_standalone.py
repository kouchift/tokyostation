...
DATA = ["version", "network", "config", "lines_meta", "genres", "score", "areas",
        ...
        "tokyo_od2", "tokyo_od", "flood", "events", "chains2", "user_pois", "bldg3d", "crime", "depth", "wikiinfo", "corp", "smoking", "camadult", "osm10", "kanto_lm", "jp_admin", "user_hensachi", "edu", "koyomi", "bigevents"]
